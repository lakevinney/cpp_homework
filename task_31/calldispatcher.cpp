...
{
    m_routingTable.insert(Mmp::value_type(std::pair<Object*, std::string>(sender,signal),
...
{
    auto it = m_routingTable.find(std::pair<Object*, std::string>(sender, signal));

    if(it != m_routingTable.end())
    {
        std::pair<Mmp_iter, Mmp_iter> recvs = m_routingTable.equal_range(std::pair<Object*, std::string>(sender, signal));
