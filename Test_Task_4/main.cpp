...
bool IsHidden(HTMLElement* elem)
{
    return elem->Hidden();
}
...
int main()
{
//    HTMLButtonElement* but = new HTMLButtonElement(10, 20, true, "Log In");
//    HTMLImageElement* img = new HTMLImageElement(10, 30, true, "http://www.pictures.com/picture1.jpg");
//    HTMLTextAreaElement* txt = new HTMLTextAreaElement(100, 100, true, "Do not copy me");



//    HTMLButtonElement* but = new HTMLButtonElement(10, 20, false, "Log In");
//    HTMLImageElement* img = new HTMLImageElement(10, 30, false, "http://www.pictures.com/picture1.jpg");
...
//    HTMLTextAreaElement* txt = new HTMLTextAreaElement(100, 100, true, "Do not copy me");
    ...
    //assert(IsHidden(elems[0]));

    //assert(all_of<HTMLElement>(elems, arrSize, IsHidden));
    //assert(!(all_of<HTMLElement>(elems, arrSize, IsHidden)));

    //assert(any_of<HTMLElement>(elems, arrSize, IsHidden));
    //assert(!(any_of<HTMLElement>(elems, arrSize, IsHidden)));
